...
protected:
    ...
    int rtsThreshold = -1;
    int data_mgmt_Cntr = 0;
    simtime_t contention_time;
    simtime_t start_time;
    simtime_t success_time;
    simtime_t fail_time;
    bool contention_flag = false;
    //statistics
    static simsignal_t LinklayerRetxnSignal;
    static simsignal_t ContentionTimeSignal;
    static simsignal_t ContentionfailedSignal;

    int frame_dropped =0;
    int frames_received = 0;
    double Linklayer_Pkt_dropRate =0;
protected:
