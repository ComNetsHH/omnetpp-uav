...
#include "inet/applications/tcpapp/WayPointsApp2.h"
...
Define_Module(WayPointsApp2);
simsignal_t WayPointsApp2::WPSISignal = registerSignal("WPSI");

WayPointsApp2::~WayPointsApp2()
{
    cancelAndDelete(timeoutMsg);
}

void WayPointsApp2::initialize(int stage)
{
...
bool WayPointsApp2::isNodeUp()
{
    return !nodeStatus || nodeStatus->getState() == NodeStatus::UP;
}

bool WayPointsApp2::handleOperationStage(LifecycleOperation *operation, int stage, IDoneCallback *doneCallback)
{
    Enter_Method_Silent();
...
void WayPointsApp2::sendRequest()
{
...
void WayPointsApp2::handleTimer(cMessage *msg)
{
    switch (msg->getKind()) {
...
void WayPointsApp2::socketEstablished(TcpSocket *socket)
{
...
void WayPointsApp2::rescheduleOrDeleteTimer(simtime_t d, short int msgKind)
{
    cancelEvent(timeoutMsg);
...
void WayPointsApp2::socketDataArrived(TcpSocket *socket, Packet *msg, bool urgent)
{
...
void WayPointsApp2::socketClosed(TcpSocket *socket)
{
...
void WayPointsApp2::socketFailure(TcpSocket *socket, int code)
{
