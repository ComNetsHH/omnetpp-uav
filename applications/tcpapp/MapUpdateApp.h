...
#ifndef INET_APPLICATIONS_TCPAPP_MAPUPDATEAPP_H_
#define INET_APPLICATIONS_TCPAPP_MAPUPDATEAPP_H_
 ...
 */
class INET_API MapUpdateApp : public App_Base, public ILifecycle
{
  protected:
    ...
    static simsignal_t NumberPixelsSignal;
    static simsignal_t MUPayloadSignal;
    static simsignal_t MUSISignal;
...
#endif /* INET_APPLICATIONS_TCPAPP_MAPUPDATEAPP_H_ */
